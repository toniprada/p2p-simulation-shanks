 ...
 *
 */
public class Cable2DPortrayal extends Link2DPortrayal {
    ...
    private void drawComplexLink(Link link, Object object, Graphics2D graphics,
        ...
        if (status.equals(Connection.STATUS_CONNECTED)) {
            graphics.setColor(Color.green);
        }  else if (status.equals(Connection.STATUS_DISCONNECTED)) {
        	graphics.setColor(Color.gray);
        }else if (status.equals(Connection.STATUS_OVERLOADED)) {
...
//         Draw the devices ID ID
    ...
    private void drawSimpleLink(Link link, Object object, Graphics2D graphics,
        ...
        if (!status.equals(Connection.STATUS_DISCONNECTED)) {
